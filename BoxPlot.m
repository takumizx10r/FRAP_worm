...
% % % % % % % Turnover Rate
figure
b=boxchart(AllData_X(:,size(AllData_X,2)),AllData_X(:,2))
...
xlabel('Time')
ylabel('Characteristic time \fontname{Times}\itT_c\rm\fontname{Arial} (s)')
...
% ax.XTickLabelRotation=45;
xlabel('Time')
ylabel('Mobile fraction \fontname{Times}\itF_{\rm{m}}')
